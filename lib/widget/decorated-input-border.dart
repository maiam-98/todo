...
class DecoratedInputBorder extends InputBorder {
  ...
  void paint(Canvas canvas, Rect rect,
    ...
    final clipPath = Path()
      ..addRRect(RRect.fromRectAndRadius(rect, Radius.circular(50)))
      ..addPath(getInnerPath(rect), Offset.zero)
      ..fillType = PathFillType.evenOdd;
    // canvas.drawOval(clipPath);
    ...
    final Rect bounds = Rect.fromLTWH(
            rect.left ,
            rect.bottom,
            rect.width + shadow.spreadRadius - 10,
            shadow.spreadRadius - 40);

    canvas.drawRRect(
        RRect.fromRectAndRadius(bounds, Radius.circular(20)), paint);


    final Paint rectPaint = Paint()..color= const Color.fromRGBO(255, 255, 255, 1);
    canvas.drawRRect(RRect.fromRectAndRadius(rect, Radius.circular(50)), rectPaint);
